...
const Home = () => {
  ...
  return (
    <div ref={main} className="relative">
      <div className="flex w-full z-10 justify-between items-center fixed top-5 px-10 max-w-[1440px] mx-auto">
        <NavLogo />
      ...
      <Container className="relative unique-parallax unique-trigger">
        ...
        <ItemContainer>
          ...
          />
          <div className="w-full md:w-1/2 pb-[50%] sm:pb-[20%]  self-start md:self-end text-[22px] font-medium">
...
function ItemContainer({ children, className, defaultPx = true }) {
  return (
    <div
      className={
        className + " " + defaultPx
          ? "px-4 sm:px-5  md:px-10 flex z-10 flex-col w-full pt-[15%] h-full"
